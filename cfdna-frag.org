...
#+end_src
#+begin_src bash
git remote add origin git@github.com:jeszyman/cfdna-frag.git
git branch -M master
git push -u origin master
#+end_src
**** Setup [[file:config/precommit_git_hook][import size check hook]]
...
ln -s /home/jeszyman/repos/cfdna-frag/config/precommit_git_hook /home/jeszyman/repos/cfdna-cna/.git/hooks/precommit
